...
@HippoEssentialsGenerated(internalName = "webarchivingaddondemov11:contentdocument")
@Node(jcrType = "webarchivingaddondemov11:contentdocument")
public class ContentDocument extends BaseDocument {
    ...
    public String getIntroduction() {
        return getProperty("webarchivingaddondemov11:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "webarchivingaddondemov11:publicationdate")
    public Calendar getPublicationDate() {
        return getProperty("webarchivingaddondemov11:publicationdate");
    }
}
